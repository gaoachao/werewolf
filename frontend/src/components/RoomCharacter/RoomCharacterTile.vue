<template>
  <div class="room-character-tile">
    ...
    <div class="controll">
      <div @click="setCharacter(character as SetableCharacters, -1)" class="down"></div>
      <div class="number">{{ num }}</div>
      <div @click="setCharacter(character as SetableCharacters, 1)" class="up"></div>
    </div>
  </div>
</template>
